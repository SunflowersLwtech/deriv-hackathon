...
def generate_ai_image(
    ...
    Returns:
        {
            "image_path": "ai_images/imagen_xyz123.png",
...
def _build_image_prompt(
    ...
    """Build an image generation prompt contextually tied to the post."""
...
def _create_placeholder_image(
    ...
    color_schemes = {
        "professional": ((25, 25, 112), (70, 130, 180)),
        "creative": ((138, 43, 226), (255, 20, 147)),
        "technical": ((47, 79, 79), (0, 128, 128))
    }
    ...
    # BUG FIX: removed invalid opacity=128 kwarg from draw.text()
    draw.text((width - wm_width - 20, height - 40), watermark, fill=(255, 255, 255, 128), font=font_small)
